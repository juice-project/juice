...
jQuery(document).ready(function () {
	juice.setDebug(true)
	juice.loadJs("http://juice-project.s3.amazonaws.com/metadefs/pines_metadef.js");
...
function buildSelectionPanel(){
	var div = '<tr><td class="rdetail_desc" nowrap="nowrap">Alternative Sources</td> <td id="ExtentionsPanel2" class="rdetail_item">' +
		'</td></tr>';
	var insert = new JuiceInsert(div,"#rdetail_online_row","after");
